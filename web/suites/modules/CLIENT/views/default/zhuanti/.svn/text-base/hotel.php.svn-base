...
<div class="painting_banner1">
	<div class="bd">
		<ul>
			<li _src="url(images/jiudian1.jpg)"></li>
		</ul>
	</div>
     ...
     <ul>
       <li>
         <div class="mr_frbox1_ne">
           ...
           <h6><span>M 1,650.00</span><small><a href="<?php echo site_url('goods/detail/403');?>">详情 ></a></small></h6>
         </div>
       </li>
      <li>
         <div class="mr_frbox1_ne">
           <h5><a href="<?php echo site_url('goods/detail/834');?>"><img src="images/jiu4.jpg"/></a></h5>
           <p class="mr_frbox1_ne1"><a href="<?php echo site_url('goods/detail/834');?>">海南皇马假日海岛风情酒店</a></p>
           <p class="mr_frbox1_ne2">大床 单早 海岛蜜月房</p>
           <h6><span>M 383.00</span><small><a href="<?php echo site_url('goods/detail/834');?>">详情 ></a></small></h6>
         </div>
       </li>
       <li>
         <div class="mr_frbox1_ne">
           <h5><a href="<?php echo site_url('goods/detail/329');?>"><img src="images/jiu5.jpg"/></a></h5>
           <p class="mr_frbox1_ne1"><a href="<?php echo site_url('goods/detail/329');?>">中江酒店</a></p>
           <p class="mr_frbox1_ne2">酒店/客栈/住宿 中江酒店储值卡（1000元）</p>
           <h6><span>M 1000.00</span><small><a href="<?php echo site_url('goods/detail/329');?>">详情 ></a></small></h6>
         </div>
       </li>
       <li>
         <div class="mr_frbox1_ne">
           ...
           <h6><span>M 688.00</span><small><a href="<?php echo site_url('goods/detail/1591');?>">详情 ></a></small></h6>
         </div>
       </li>
       <li>
         <div class="mr_frbox1_ne">
           <h5><a href="<?php echo site_url('goods/detail/998');?>"><img src="images/jiu7.jpg"/></a></h5>
           <p class="mr_frbox1_ne1"><a href="<?php echo site_url('goods/detail/998');?>">海口假日广场商务酒店</a></p>
           <p class="mr_frbox1_ne2">豪华大床房 无早 免费宽带馆</p>
           <h6><span>M 248.00</span><small><a href="<?php echo site_url('goods/detail/998');?>">详情 ></a></small></h6>
         </div>
       </li>
     </ul>
   </div>
   ...
   <div class="housing_header1 clearfix">
     ...
     <div class="tempWrap2">
       ...
       <ul>
         ...
         <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/834');?>"><img src="images/jiu12.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/834');?>">海南皇马假日海岛风情酒店</a></p>
           <p class="mr_frbox1_2">大床 单早 海岛蜜月房</p>
           <h6><span>M 383.00</span><small><a href="<?php echo site_url('goods/detail/834');?>">详情 ></a></small></h6>
           </div>
         </li>
         <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/329');?>"><img src="images/jiu13.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/329');?>">中江酒店</a></p>
           <p class="mr_frbox1_2">酒店/客栈/住宿 中江酒店储值卡（1000元）</p>
           <h6><span>M 1000.00</span><small><a href="<?php echo site_url('goods/detail/329');?>">详情 ></a></small></h6>
           </div>
         </li>
       </ul>     
    ...
    <div class="housing_header1 clearfix">
      ...
      <ul>
       <li class="tempWrap2_nei2">
          ...
          <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/329');?>"><img src="images/jiu16.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/329');?>">中江酒店</a></p>
           <p class="mr_frbox1_2">酒店/客栈/住宿 中江酒店储值卡（1000元）</p>
           <h6><span>M 1000.00</span><small><a href="<?php echo site_url('goods/detail/329');?>">详情 ></a></small></h6>
           </div>
          ...
          <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/834');?>"><img src="images/jiu17.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/834');?>">海南皇马假日海岛风情酒店</a></p>
           <p class="mr_frbox1_2">大床 单早 海岛蜜月房</p>
           <h6><span>M 383.00</span><small><a href="<?php echo site_url('goods/detail/834');?>">详情 ></a></small></h6>
           </div>
      ...
      <ul>
       <li class="tempWrap2_nei2">
           ...
           <h6><span>M 3000.00</span><small><a href="<?php echo site_url('goods/detail/411');?>">详情 ></a></small></h6>
           </div>
         </li>
          <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/998');?>"><img src="images/jiu19.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/998');?>">海口假日广场商务酒店</a></p>
           <p class="mr_frbox1_2">【商务酒店】海口假日广场商务酒店 豪华大床房 无早 免费宽带</p>
           <h6><span>M 248.00</span><small><a href="<?php echo site_url('goods/detail/998');?>">详情 ></a></small></h6>
           </div>
         </li>
          <li class="tempWrap2_nei2">
           <div class="mr_frbox1_ne1">
            <h5><a href="<?php echo site_url('goods/detail/834');?>"><img src="images/jiu20.jpg"/></a></h5>
           <p class="mr_frbox1_1"><a href="<?php echo site_url('goods/detail/834');?>">海南皇马假日海岛风情酒店</a></p>
           <p class="mr_frbox1_2">大床 单早 海岛蜜月房</p>
           <h6><span>M 383.00</span><small><a href="<?php echo site_url('goods/detail/834');?>">详情 ></a></small></h6>
           </div>
