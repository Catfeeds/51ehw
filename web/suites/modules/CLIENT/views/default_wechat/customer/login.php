...
.login-num {height: 40px; width: 93.33%; margin-bottom: 15px; border: 1px solid #FCFCFC; border-radius: 2px; font-size: 15px; text-indent: 10px;}
.login-mima {height: 40px; width: 93.33%; margin-bottom: 20px; border: 1px solid #FCFCFC; border-radius: 2px; font-size: 15px; text-indent: 10px;}
.login-more {position: relative;width:90%;left:5%;margin-top: 200px;}
.logo_main {text-align: center; padding-top: 15px;}
</style>
	<form action="<?php echo site_url('customer/check_customer')?>"
		...
		<div class="logo_main">
			...
			<input type="text" value="" placeholder="请输入手机号码"
				name="tbxLoginNickname" required="required" class="login-num"><br>
			<input type="password" value="" placeholder="请输入登录密码"
				name="tbxLoginPassword" required="required" class="login-mima"><br>
			<button id="login_sub">登录</button>
			<br>
			<a href="<?php echo site_url("customer/forget_password");?>"> <span class="login-forget-password">忘记密码？</span></a>
		</div>
	</form>
