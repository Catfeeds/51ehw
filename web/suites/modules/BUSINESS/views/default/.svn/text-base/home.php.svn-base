...
<?php if($this->session->userdata('user_id')):?>
	  <div class="vertisement1"><a href="<?php echo site_url('member/demand/demand_list').'?cateid=99999&keyword=&sort=1'?>"><img src="images/banner6.png"/></a></div> 
<?php else:?>
	<div class="vertisement1"><a href="<?php echo site_url('member/demand/demand_list').'?cateid=0&keyword=&sort=1'?>"><img src="images/banner6.png"/></a></div>
<?php endif;?> 
...
{
//echo include(FCPATH.UPLOAD_PATH."uploads/siteinfo/homeplate_".$this->session->userdata('app_info')["id"].".html");
	include(FCPATH.UPLOAD_PATH."uploads/siteinfo/homeplate_".$this->session->userdata('app_info')["id"].".html");
}else
{
//echo FCPATH.UPLOAD_PATH."uploads/siteinfo/homeplate_0.html";
 ...
 <!--<div id='nav' class="xiangyou">
                    <div class="yincang" style="margin-top: 75px;display: block; float: left; margin-left: 6px;"><img src="images/x_alt_1.png"></div>
                    <ul>
                    <li><a class="f1 bian_1" href='#f1'></a></li>
                    <li><a class="f2 bian_2" href='#f2'></a></li>
                    <li><a class="f3 bian_3"href='#f3'></a></li>
                    <li><a class='f4 bian_4' href='#f4'></a></li>
                    <li><a class='f5 bian_5' href='#f5'></a></li>
                    <li><a class='f6 bian_6' href='#f6'></a></li>
                    <li><a class='f7 bian_7' href='#f7'></a></li>
                    <li><a class='f8 bian_8' href='#f8'></a></li>
                    <li><a class='f9 bian_9' href='#f9'></a></li>
                    <li class="fanhui1"> </li>
                    </ul>
           </div>-->
   <!--<?php //$app_id = $this->session->userdata('app_info')['id'];
  // if($app_id==0){?>
   <div id="nav_right" class="xiangyou">
     <div class="yincang" style="margin-top: 75px !important;display: none; float: right; margin-right: 7px;"><img src="images/x_alt_1.png"></div>
    <ul>
      <li><a href="http://www.51ehw.com/goods/detail/2290"></a></li>
      <li><a href="http://www.51ehw.com/goods/detail/2289"></a></li>
       <li><a href="http://www.51ehw.com/goods/detail/1087"></a></li>
   </ul>
   </div>
   <?php //};?>-->
...
.yincang{ margin-top:76px !important; margin-left:1px!important}
</style>-->
...
$(".yincang").click(function(e){
		...
		$("#nav_right").addClass("display-none");
})

			$(function() {
			$('.xiangyou').mouseover(function() {
			$('.yincang').show();
			});
			$('.xiangyou').mouseout(function() {
			$('.yincang').hide();
			})
			})
