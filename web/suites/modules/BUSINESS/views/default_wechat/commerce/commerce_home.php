...
<!-- app下载 -->
<div class="go_home">
   <div><img src="images/commerce/commerce_app.png" alt=""></div>
   <div class="go_home_app">
      <a href="javascript:download('android')"><img src="images/commerce/commerce_app_android.png" alt=""></a>
      <a href="javascript:download('ios')" style="margin-top: 10px;"><img src="images/commerce/commerce_app_ip.png" alt=""></a>
   </div>
