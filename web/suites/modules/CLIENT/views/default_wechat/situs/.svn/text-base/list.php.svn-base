	<div class="container" style="background-color: #EEEEEE">
        <div class="station_form">
        	<p><a href="javascript:void(0);" class="icon-sousuo"></a><input type="text" oninput="search()" value="" placeholder="请输入站点名称或字母" id="search">  </p>
        </div>
        <span id="cover">
        <!-- 定位站点 -->
        <div class="station_positioning">
        	<span>定位站点</span></br>
        	<a  class="station_positioning_name"></a>
        </div>
         <!-- 最近访问站点 -->
...
<!--           </div> -->
       ...
       <!-- 分站点内容 end -->
       <!-- <div style="width: 100%; height:20px; background:#eee; margin-bottom:50px;"></div> -->
    </div>   
</body>
