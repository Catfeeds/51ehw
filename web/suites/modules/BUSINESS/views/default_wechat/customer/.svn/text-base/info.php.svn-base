<div class="page clearfix">
	...
	<div class="member_box">
		<a href="<?php echo site_url("Member/info/accountsettings"); ?>" class="personal_information_entrance">
		...
		<ul class="member_head_list clearfix">
		    ...
		    <li style="position:relative"><a href="<?php echo site_url("Tribe/ManagementTribe");?>"><span class="fn-left "style="padding-right: 10px;font-size: 18px;"><em class="icon-tianjiabula1"></em></span>
			<span class="fn-right red"><em class="icon-right c9"></em></span>部落管理<?php echo ($count_unaudited_tribe > 0)?"<span class='bianhongse'>".(($count_unaudited_tribe > 99)? '99+' : $count_unaudited_tribe)."</span>":""?></a></li>
			<?php };?>
...
<!-- 			<li><a href="javascript:void(0);"><span class="fn-left "style="padding-right: 10px;font-size: 18px;"><em class="icon-saoyisao"></em></span>
			...
			<li><a href="<?php echo site_url('member/requirement/needs_manage')?>"><span class="fn-left "style="padding-right: 10px;font-size: 18px;"><em class="icon-dingdanyiwancheng4"></em></span>
			...
			<li class="hehuoren-i5" style="border-top: 10px solid #f2f2f2;height: 50px;margin-bottom: 55px;"><a href="<?php echo site_url('Agent/home/login')?>"><span class="fn-left "style="padding-right: 10px;font-size: 18px;"><em class="icon-people"></em></span>
			</span>合伙人登录</a></li>
		</ul>
	</div>
	<!-- 底部版本说明 -->
