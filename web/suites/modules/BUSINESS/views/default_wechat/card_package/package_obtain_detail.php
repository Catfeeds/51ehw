        ...
        <?php };?>
         <!-- 现场核销 -->
            ...
            <div class="red_packet_but goods_packet_but" >
                ...
                <?php }else{;?>
                <a href="<?php echo site_url("Search/discount_goods/{$package["id"]}");?>" class="custom_button">马上使用</a>
                <?php };?>
                <a href="<?php echo site_url("Corporate/card_package/my_package");?>" class="custom_button">我的卡包</a>
            </div>
            <?php };?>
