<style type="text/css">
	...
	.icon-roundcheckfill {color: #fe4101;font-size: 18px;border: 0!important;}
...
<form name="charge" method="post" action="<?php echo site_url("charge/Web_Change_Submit")?>">
	<div class="charge_pay"> 
		  ...
		  <ul>
		   <?php if (strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger') === false):?>
		    <li><img src="images/zhifubao.png" alt="" class="charge_pay_zhifubao"><em data-value="1" class="icon-roundcheckfill"></em></li>
		    <li><img src="images/yinlian_pay.jpg" alt="" class="charge_pay_yinlian"><em data-value="3"></em></li>
		   <?php else:?>
		    <li><img src="images/weixin_pay.png" alt="" class="charge_pay_weixin"><em data-value="2" class="icon-roundcheckfill"></em></li>
		    <li><img src="images/yinlian_pay.jpg" alt="" class="charge_pay_yinlian"><em data-value="3"></em></li>
		   <?php endif;?>
		  </ul>
	...
	<div class="cash_recharge_button">
		<button type="button" onclick="checkSubmit()">确定</button>
	</div>
	<!-- 充值未成功的时候显示 -->
...
<?php endif;?>
 ...
 $(".charge_pay ul li").on("click",function(){
 	$(this).children('em').addClass("icon-roundcheckfill");
 	$(this).siblings('li').children('em').removeClass('icon-roundcheckfill');
