...
var $is_activity;
	 ...
	 * @param $search 搜索参数
	 */
	public function get_package($id=0,$status=0,$search=null,$offset=null,$limit=null,$corp_id = 0 ){
        ...
        $this->db->where("a.corporation_id", $corp_id ? $corp_id : $this->session->userdata("corporation_id"));
        $query = $this->db->get();
        if($id){
...
//                 break;
     ...
     */
    public function  discount_goods($p_id,$customer_id){
     ...
     */
    public function goods_coupons($product_id,$customer_id,$p_id=0){
