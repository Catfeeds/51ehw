...
<?php if( isset($address) && count($address)>0){?>
			...
			<ul>
				<li>
					...
					<div class="address_bts"
						...
						<a href="<?php echo site_url('easyshop/address/edit/'.$v['id']);?>" class="eidt fn-right" style="padding-right: 25px; color: #666666 !important;">
						<em class="icon-bianji" style="padding-right: 6px;"></em>编辑</a>
						<a href="<?php echo site_url('easyshop/address/del/'.$v['id']);?>" class="delete fn-right" style="padding-right: 25px; color: #666666 !important;">
	...
	<div style="border-bottom: 1px solid #F3F3F3; line-height: 35px;">
		<a href="<?php echo site_url('easyshop/address/add');?>" style="font-size: 13px; padding-left: 10px;">
    		<span>添加收货地址</span>	
...
<?php }else{ ?>
	...
	<div class="address_kong" style="text-align: center;">
		...
		<div
			...
			<a href="<?php echo site_url('easyshop/address/add');?>"><span
...
function set_default($id){
    ...
    $.post("<?php echo site_url('easyshop/address/set_default')?>",{id:$id},function(data){
