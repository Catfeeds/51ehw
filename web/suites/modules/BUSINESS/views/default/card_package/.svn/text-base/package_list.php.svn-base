			...
			<div class="search_0">
				...
				<table width="910" border="1" cellpadding="0" cellspacing="0" class="table1 manage_b_table1">
                    ...
                    <tr>
                       ...
                       <th width="148px"><a href="<?php echo site_url("corporate/card_package/add_view/".$v["id"]);?>" style="color:#fca543; text-decoration:underline; margin-right:32px;">编辑</a> <a href="javascript:;" onclick="approve(this,<?php echo $v["id"];?>,<?php echo $v['status'];?>)" style="color:#fca543; text-decoration:underline">
                       <?php switch ($v['status']){
                            case "0":
                                echo "提交审核";
                                break;
                       ...
                       </a> &nbsp;<a href="<?php echo site_url("corporate/card_package/detail").'/'.$v['id'];?>"  style="color:#fca543;     display: inline-block;text-decoration:underline">查看详情</a></th>
                    </tr>
                    <?php };?>
                    <?php };?>
