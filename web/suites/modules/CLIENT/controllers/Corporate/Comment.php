...
class Comment extends Front_Controller {
	...
	public function get_list($type=''){
	    ...
	    $customerInfo = $this->session->userdata ['corporation_id' ];
	    $appInfo = $this->session->userdata ( 'app_info' );
	    $condition['corporation_id']=$customerInfo;
...
//         print_r($search_name);exit;
	    ...
	    $data['askcount'] = $this->demand_mdl->get_demand($customerInfo,null,null,1);//显示总条数
