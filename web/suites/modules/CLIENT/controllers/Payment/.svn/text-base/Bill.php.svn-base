...
class Bill extends Front_Controller {
...
// 		echo MYSHOP_SHARE_PATH.'libraries/payment/99bill/pcarduser.pem';
		...
		$request_url = 'https://sandbox.99bill.com/gateway/recvMerchantInfoAction.htm';
		$post_string = array(
	...
	{
		$this->load->library('request');
		$request_url = site_url('payment/bill/recieve');//'https://sandbox.99bill.com/gateway/recvMerchantInfoAction.htm';
		$this->request->request_by_jsfrom($request_url,array('foo' => 'var', 'id' => 123));
	}
