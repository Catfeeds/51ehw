...
.needs_list_table .needs_list_table_li03 {width:173px;}
</style>
<script>
//顶部菜单
//站点菜单
...
<div class="content_company clearfix">
    ...
    <div class="needs_list_main">
       ...
       <div class="needs_list_table">
           <ul style="height: 42px;line-height: 42px;background:#FEE0C0;">
           ...
           <ul class="needs_list_table_ul" style="line-height: 90px;">
               ...
               <li class="needs_list_table_li06" style="line-height: 15px;"><span style="display: block;margin-top: 35px;" id="<?php echo 'price_'.$v['id']?>"><?php echo $v['min_vip_price'];?>～<?php echo $v['max_vip_price'];?>货豆</span></li>
...
<script type="text/javascript">
    ...
    $(".needs_list_header_right a").on("click",function(){
       $("#dingdan4_3_tanchuang03").css("display","block");
    })
