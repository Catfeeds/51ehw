...
<div class="ui-wines-banner fn-left">
      <div class="flexslider">
          ...
          <?php foreach($ad_top as $ad):?>
          	<li><a <?php echo $ad['url']?'href="'.$ad['url'].'"':'';?>><img src="<?php echo $ad['img_url'];?>" /></a></li>
          <?php endforeach;?>
          </ul>
        </div>
</div>
<ul class="ui-shop-hot fn-right">
    ...
    <li class="<?php if($k>0) echo "m-top10";?>">
        ...
        <a href="<?php echo site_url('goods/detail/'.$v['id']);?>" target="_blank" title="">
            <img src="<?php echo base_url('uploads/'.$v['goods_thumb']);?>">
        </a>
    </li>
    <?php endforeach;?>
</ul>
    ...
    <?php foreach ($list_goods_wine as $k=>$v):?>
        <li>
            <div class="ui-goods-pic">
                <a href="<?php echo site_url('goods/detail/'.$v['id']);?>"><img src="<?php echo base_url('uploads/'.$v['goods_thumb']);?>"></a>
            </div>
...
<div class="ui-section-box fn-clear">
    <div class="ui-section-left fn-left">
        ...
        <?php foreach($ad_yj_left as $ad):?>
          	<li>
                <a <?php echo $ad['url']?'href="'.$ad['url'].'"':'';?>><img src="<?php echo $ad['img_url'];?>"/> </a>
            </li>
          <?php endforeach;?>
        </ul>
    </div>
