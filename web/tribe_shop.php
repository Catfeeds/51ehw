...
<style type="text/css">
  ...
  .essay_classify_fuwu_list {border-bottom: 1px solid #ddd;padding: 5px;}
...
<style type="text/css">
  ...
  .essay_classify_main {margin: 0px;margin-top: -30px;}
...
<div class="search-header">
   ...
   <form  id="form_search">
       <div class="nav_search">
          ...
          <input type="text" class="search_input" name="keyword" value="<?php echo isset($keyword)?$keyword:"" ?>" placeholder="搜索您想找的商品" required="" style="width:85%;color#606060;height:34px;background-color: #fff;border: none;font-size: 15px;padding-left:0;">
          </a>
          </p>
...
<div class="essay_preview" id="ceshi">
  <!-- 导航 -->
  <div class="tribal_new_nav"><!-- onclick="barnavigation(this,2);" -->
            ...
            <?php foreach($goods as $v){; ?>
              <a href="<?php echo site_url("Goods/detail/".$v["id"]);?>">
                ...
                <div class="good-text-bg">
                   ...
                   <span class="essay-goods-monery"><?php echo $v["tribe_price"];?>货豆</span>
                </div>
            </a>
            <?php }; ?>
        </div>
            ...
            <div class="essay_classify_fuwu_list">
              <a href="<?php echo site_url("Goods/detail/".$v["id"]);?>">
                ...
                <div class="essay_classify_fuwu_list_text">
                   <span class="essay-goods-title"><?php echo $v['name'];?></span>
                   <span class="essay-goods-monery">部落价：<?php echo $v["vip_price"];?>货豆</span>
                </div>
              </a>
            </div>
            <?php }; ?>
...
<!-- 企业形象 -->
<span id="corporationstyle" hidden>
...
function stick (id,stick) {
	if (stick == '0') {
		...
		document.getElementById("tuichu_ball_text").innerHTML = '取消置顶该商品？';
	}
