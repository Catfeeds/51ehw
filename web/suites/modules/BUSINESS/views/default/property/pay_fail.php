		...
		<div class="huankuan_cmRight" style="display:block">
            <div class="huankuan_rTop_5" style="display: block">充值成功</div>
                <div class="transformation_1" style="display:none">
                   ...
                   <h5>充值成功</h5>
                   <p><a href="＃">点击查看我的资产</a></p>
                 </div>
            </div>
            <div class="huankuan_cmRight" style="display:none">
            <div class="huankuan_rTop_5" style="display: block">充值失败</div>
                <div class="transformation_1" style="display:none">
                   <span><img src="images/fail.png"/></span>
                   <h5>充值失败</h5>
                   <p><a href="＃">点击查看我的资产</a></p>
                 </div>
            </div>
