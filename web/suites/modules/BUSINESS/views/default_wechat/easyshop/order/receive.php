...
<div style="z-index: 997;">
    ...
    <div class="h5-forget" id="skip_bullet" hidden>
    	...
    	<div class="forget-password">
    		...
    		<a href="<?php echo site_url("member/info/paypwd_edit");?>" class="password-button custom_button">设置</a>
    	</div>
    </div>
    <?php
            break;
		...
		<div class="forget2-password">
			<div class="password-text">
				...
				<div id="order_money_text" style="margin-top: 5px;">
					<span class="float-left">订单金额：</span>¥<span class="diagndan-monery" id='price'></span>
				</div>
				<div style="margin-top: 5px;">
					<span class="float-left">支付密码：</span><input type="password" value="" class="mima-forget" name="pay_passwd">
				</div>
			</div>
			<a href="javascript:void(0);" class="password-button custom_button" id="pay_">确定支付</a>
			<div>
...
<!-- 	M卷余额不足隐藏窗口 -->
	 <div class="h5-forget" id="skips_bullet" hidden>
        <div class="h5-lose">
        	<img src="images/51h5-lose.png" id="close_img" height="34" width="34">
        </div>
    	<div class="forget-password">
    ...
    <div class="h5-forget" id="just_sure" hidden>
    	...
    	<div class="forget-password">
    		...
    		<a href="javascript:void(0);" class="password-button custom_button" id="sure_submit">确定</a>
    	</div>
    </div>
</div>
