                    ...
                    <?php if(count($list) > 0):?>   
                        <?php foreach ($list as $v):?>
                            <tr>
                                ...
                                <th width="178px">
                                	<!--  <a href="#" style="color:#fe4101; margin-right:40px; text-decoration:underline">编辑</a>-->
                                    <a href="<?php echo site_url('corporate/customer/customer_consume_list/'.$v['id'])?>" style="color:#fe4101; text-decoration:underline">消费记录</a>
                                </th>
                            </tr>
                        <?php endforeach;?>   
                    <?php else: ?>
