...
<select id="select_api">
    <option value="0">修改商户(调用方)信息( 如有需要 )</option>
...
<!--     <option value="9">微信openid登录-接口测试</option> -->
    ...
    <option value="23">商家可赠送优惠券列表-接口测试</option>
    <option value="24">用户优惠券列表-接口测试</option>
    <option value="25">赠送优惠券-接口测试</option>
    <option value="26">优惠券详情-接口测试</option>
    <option value="27">优惠券检测-接口测试</option>
    <option value="28">查询API商户的支付账户-接口测试</option>
</select><br/><br/>

<!-- 设置接口信息 -->
<div id="Update_Api_Info" class="view" >
<h3>修改商户(调用方)信息（修改接口方在易货网中记录的信息)</h3>
    <form action="<?php echo site_url('Api_other/Api_account/Update_Api_Info/')?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        商户key(接口方提供)：<input type="text" name="app_key" value=""><br/><br/>
        用户ID：<input type="text" name="customer_id" value=""><br/><br/>
        店铺ID：<input type="text" name="corporation_id" value=""><br/><br/>
        指定唯一产品ID：<input type="text" name="product_id" value=""><br/><br/>
...
<!-- 获取商家已审核通过的优惠券 -->
<div id="preferential" class="view" hidden>
    <h3>说明：商户在易货网中可提供给用户的优惠券列表</h3>
    <form action="<?php echo site_url('Api_other/Preferential/preferential_list');?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        商户ID<input type="text" name="corporation_id" value=""><br/><br/>
        商户key(接口方提供)：<input type="text" name="app_key" value=""><br/><br/>
       <input type="submit" value="提交">
    </form>
</div>
...
<!-- 用户获得商家赠送的优惠券列表 -->
<div id="load" class="view" hidden>
    <h3>用户优惠券列表</h3>
    <form action="<?php echo site_url('Api_other/Preferential/load');?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        用户登录key：<input type="text" name="key" value=""><br/><br/>
        状态：<input type="text" name="status" value="4">1:已使用,2:未使用,3:已过期,4:全部<br/><br/>
       <input type="submit" value="提交">
    </form>
</div>

<!-- 商家赠送优惠券 -->
<div id="preferential_give" class="view" hidden>
    <h3>商家赠送优惠券</h3>
    <form action="<?php echo site_url('Api_other/Preferential/preferential_give')?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        商户key(接口方提供)：<input type="text" name="app_key" value=""><br/><br/>
        优惠券ID <input type="text" name="card_id" value=""><br/><br/>
        受赠用户ID：<input type="text" name="customer_id" value=""><br/><br/>
       <input type="submit" value="提交">
    </form>
</div>
...
<!-- 优惠券详情 -->
<div id="preferential_detail" class="view" hidden>
    <h3>优惠券详情</h3>
    <form action="<?php echo site_url('Api_other/Preferential/preferential_detail')?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        优惠券ID <input type="text" name="card_id" value=""><br/><br/>
        <input type="submit" value="提交">
    </form>
...
<!-- 优惠券详情 -->
<div id="check_preferential" class="view" hidden>
    <h3>优惠券检测：</h3>
    <form action="<?php echo site_url('Api_other/Preferential/check_preferential')?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        优惠券ID <input type="text" name="card_id" value=""> <br/><br/>
        返回 status = 0:有效  -1:优惠券不存在   -2:优惠券不在发放时范围内 - 3:优惠券已被领完 <br/><br/>
        <input type="submit" value="提交">
    </form>
</div>
...
<!-- 优惠券详情 -->
<div id="Load_Api_Pay" class="view" hidden>
    <h3>查询接口商户的支付账户：</h3>
    <form action="<?php echo site_url('Api_other/Api_account/Api_Pay_Info/')?>" method="post">
        商户号(接口方提供)：<input type="text" name="app_id" value="ehw0000001xx"><br/><br/>
        商户key(接口方提供)：<input type="text" name="app_key" value=""><br/><br/>
        返回字段 status = 0 获取成功，可用余额 = (M_credit=货豆余额) + (credit=授信余额)<br/><br/>
        <input type="submit" value="提交">
    </form>
</div>
...
$("#select_api").change(function () {  
	 ...
	 switch(choose){ 
    	 ...
    	 case '24':
        	 ...
        	 break;
    	 case '25':
        	 $('#preferential_give').show();
        	 break;
    	 case '26':
    		 $('#preferential_detail').show();
    		 break;
    	 case '27':
    		 $('#check_preferential').show();
    		 break;
    	 case '28':
    		 $('#Load_Api_Pay').show();
    		 break;
