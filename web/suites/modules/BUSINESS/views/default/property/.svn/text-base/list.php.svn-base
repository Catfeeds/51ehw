...
<div class="dingdan4_5_tanchuang" style="display:none">
  <div class="dingdan4_3_tanchuang_con">
      ...
      <div class="dingdan4_3_tanchuang_top2">
          <p id='prompt'><input type="password" value="" placeholder="输入支付密码" name="pay_password" class="input-text1"><span><a href="<?php echo site_url('member/save_set/paypwd_set/forgetpay')?>">忘记密码？</a></span></p>
