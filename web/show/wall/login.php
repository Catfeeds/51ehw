...
if(!$bakurl){
	$bakurl = 'index.php?style=2015year';
	}
require 'db.php';
...
<div class="container" style="width:60%">
        <div class="login-screen">
          <div class="login-icon col-xs-3 hidden-sm hidden-xs">
            <img src="../files/images/icons/png/logo.png" alt="Welcome to Mail App" />
          ...
          <div class="login-form">
            ...
            <a class="login-link" href="/" target="_blank">Powered by:9TH LEAF</a>
          </div>
        </div>
</div>
</body>
