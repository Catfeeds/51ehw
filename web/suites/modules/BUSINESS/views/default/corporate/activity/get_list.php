				        ...
				        <?php foreach ($activity_product_list as $v):?>
                            <tr>
                                ...
                                <?php if($v['status'] == 1): ?>
                                    ...
                                    <?php endif;?>
                                    <th width="178px"><a href="<?php echo site_url('corporate/activity/activity_order_list/'.$v['activity_num'])?>" style="color:#fca543; text-decoration:underline">查看拼团明细</a>
                                    <a href="<?php echo site_url('corporate/activity/create_activity/'.$v['id'].'/1')?>" style="color:#fca543; text-decoration:underline">查看活动明细</a></th>
                                <?php elseif ($v['status'] == 2):?>
                                    <th width="76px">新建</th>
                                    <th width="178px"><a href="<?php echo site_url('corporate/activity/create_activity/'.$v['id'])?>" style="color:#fca543; text-decoration:underline; margin-right:32px;">编辑</a> <a href="javascript:;" onclick="approve(<?php echo $v['id']?>,this)"  style="color:#fca543; text-decoration:underline" >提交审核</a></th>
                                <?php elseif ($v['status'] == 3):?>
                                    <th width="76px">审核中</th>
                                    <th width="178px"><a href="<?php echo site_url('corporate/activity/create_activity/'.$v['id'].'/1')?>" style="color:#fca543; text-decoration:underline">查看活动明细</a></th>
                                <?php elseif ($v['status'] == 4):?>
                                    <th width="76px">审核不通过</th>
                                    <th width="178px"><a href="<?php echo site_url('corporate/activity/create_activity/'.$v['id'])?>" style="color:#fca543; text-decoration:underline; margin-right:32px;">编辑</a> <a href="javascript:;" onclick="approve(<?php echo $v['id']?>,this)"  style="color:#fca543; text-decoration:underline" >重新提交审核</a></th>
                                <?php else:?>
                                    <th width="178px"><a href="<?php echo site_url('corporate/activity/activity_order_list')?>" style="color:#fca543; text-decoration:underline"></a></th>
                                <?php endif;?>
                            </tr>
                        <?php endforeach;?>
                    </table>
    ...
    $.post("<?php echo site_url('corporate/activity/update_activity_status')?>",{id:id},function(data){
        switch(data){ 
            case 1 :
                ...
                $(obj).parent().append('<a href="<?php echo site_url('corporate/activity/create_activity')?>/'+id+'/1" style="color:#fca543; text-decoration:underline">查看活动明细</a>');
                $(obj).remove();
                break;
            case 2 :
            	$('.dingdan4_3_tanchuang').show();
