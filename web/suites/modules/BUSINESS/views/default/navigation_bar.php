        ...
        <div class="macth_xv_navlist">
            <div class="macth_xv_menu">
                    ...
                    <div class="macth_xv_cat_catlist ">
                        <ul class="macth-dropdown-menu" data-bind="foreach:navData">
                            <li class="macth_xvitem" data-bind="attr:{'data-submenu-id':$data.id}">
                                <a  class="icon-hover"href="text:$data.url" data-bind="attr:{'href':'<?php echo site_url('goods/search');?>/'+$data.cat_id},'text':$data.title"><h3>
                                     ...
                                     <div class="macth_popover-content">
                                        <ul class="macth_content_ul" data-bind="foreach:$data.content">
                                            <li class="macth_nav_li">
                                                <a class="macth_xvnav_li_alist" href="text:$data.url" data-bind="attr:{'href':'<?php echo site_url('goods/search');?>/'+$data.cat_id},'text':$data.title"></a>
                                                <ul class="macth_xvnav_li_ul" data-bind="foreach:$data.content">
                                                    <li>
                                                        <a href="text:$data.url" data-bind="attr:{'href':'<?php echo site_url('goods/search');?>/'+$data.cat_id},'text':$data.title"></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                ...
                <ul class="macth_xv_nav">
                    <li <?php echo isset($Home) && $Home  ? "class='macth_liactive'":""?>><a href="<?php echo site_url('home')?>">首页</a></li>
                     
                    <li <?php echo isset($type) && $type == '广告' ? "class='macth_liactive'":""?>><a href="<?php echo site_url('goods/zhuanti/3');?>">广告</a></li>
                    <li <?php echo isset($type) && $type == '餐饮' ? "class='macth_liactive'":""?>><a href="<?php echo site_url('goods/zhuanti/2');?>">餐饮</a></li>
                    <li <?php echo isset($type) && $type == '书画' ? "class='macth_liactive'":""?>><a href="<?php echo site_url('goods/zhuanti/1');?>">书画</a></li>
                    <li <?php echo isset($type) && $type == '房屋' ? "class='macth_liactive'":""?>><a href="<?php echo site_url('goods/zhuanti/4');?>">房屋</a></li>
                    <li <?php echo isset($type) && $type == '酒店' ? "class='macth_liactive'":""?>><a href="<?php echo site_url('goods/zhuanti/hotel');?>">酒店</a></li>
