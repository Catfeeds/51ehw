...
class Cloud_sms_short_message implements Short_message
{
    ...
    function send($phonenum, $content, $rand_code = '')
    {
        ...
        $url = $this->URL . "maap/sms/code?sid=" . $this->USERNAME . "&appId=2e55fe83009f4bb78a6a45a883cfc9c1&time=" . $messagenum . "&sign=" . MD5($this->USERNAME . $messagenum . "b8e8f0c0bb2aebb204a9bf8723c0b0b9") . "&to=" . $phonenum . "&templateId=21329&param=" . $rand_code;
