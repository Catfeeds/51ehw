...
$options['client_id']='YXA6bZRHEG0eEeeyLoGg_S8Sfg';
$options['client_secret']='YXA66J5F_NoG2GZ_8fcQRLNLxSdHqlI';
$options['org_name']='1141170719115422';
$options['app_name']='tribebox-test';
...
// 		var_dump($token);
		break;
	case 11://创建单个用户
// 	    $h->createUser("lisis","123456");
echo  '<pre>';
print_r($h->createUser("lisis4","123456"));
// 		var_dump($h->createUser("lisis","123456"));
		break;
	case 12://创建批量用户
	...
	case 36://发送透传消息
		...
		break;
	case 37://发送图片消息
// 		$filePath=FCPATH.UPLOAD_PATH."uploads/resource/up/pujing.jpg";
		$filePath='http://images.51ehw.com/B/app/siteinfo/index/images/app_homeplate/1499150747_index_4.JPG';
		$from='admin';
		$target_type="users";
		$target=array("11");
		$filename="pujing.jpg";
		...
		$ext['b']="b";
		echo '<pre>';
		$a = $h->sendImage($filePath,$from,$target_type,$target,$filename,$ext);
		print_r($a);
