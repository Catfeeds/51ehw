...
<div class="system_chatting1">
  ...
  <div class="im-content1">
    ...
    <div class="client_side_top">
       <ul>
           <li class="commodity_information"><a href="javascript:void(0);" id="information_1">商品信息</a></li>
           <li><a href="javascript:void(0);" id="information_2">客户信息</a></li>
       </ul>
    </div>
    
    <div class="im-right-merchant" style="display:block"> 
...
<script>
$("#information_2").click(function(){
	    $(".im-right-sidebar").css("display","block");
	    $(".im-right-merchant").css('display','none'); 
	    $("#information_1").parent().removeClass();
 		//$(".huankuan_rTop").hide()
		//$(".huankuan_rTop_1").hide()
 	    $("#information_2").parent().addClass("commodity_information");
 		});

$("#information_1").click(function(){
	    $(".im-right-merchant").css("display","block");
	    $(".im-right-sidebar").css('display','none'); 
	    $("#information_2").parent().removeClass();
 	    $("#information_1").parent().addClass("commodity_information");
 		});
</script>