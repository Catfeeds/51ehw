...
<!-- 刷选导航 -->
 ...
 <div class="my-needs-nav" style="padding-bottom: 45px;">
 	<ul>
     <li style="width:30%"><a href="<?php echo site_url("Member/requirement/classify?keyword=")?>" style="color:#333333" >分类选择<span  ></span></a></li>
         <li style="width:25%"><a href="<?php echo site_url("Member/requirement/index")?>" >精选推荐</a></li>
	     <li style="width:25%"><a  href="<?php echo site_url("Member/requirement/all_demand")?>" class="active_nav">需求总价</a></li> 
...
dropload = $('#main').dropload({
	...
	loadDownFn : function(me){
		 ...
		 $.post("<?php echo site_url("Member/requirement/ajax_list");?>",{page:page,keyword:keyword,cate_id:cate_id,orderBy:type,is_all:is_all},function(data){
