...
<form action="<?php echo site_url('Circles/test');?> "method="post" enctype="multipart/form-data" id="form1">
  <div class="container container_topd">
       <div class="release_pictures" style="margin-top: 0px;">
         <div class="release_pictures_top">
         
         <textarea class="example_top" id="taContent" rows="3" name='content' placeholder="请输入详情（1000字以内）"></textarea>
            ...
            <section class=" img-section">
                <div class="z_photo upimg-div clear" >
                         <section class="z_file z_file_lo" id='test'>
                            ...
                            <input runat="server" type="file" name="file[]" id="file_0"  accept="image/*" class="file" value="" onchange="upload_img('file_0')" multiple/>
...
{ 
	...
	if(!imgarr[0] && !content){
		$(".black_feds").text('请填写相关信息').show();return;
	}
	...
	$('#form1').ajaxSubmit({
  	    url: '<?php echo site_url("Corporation_style/Create_Topic")?>',
    	type: 'POST',
    	//cache: false,
...
{		
		...
		html = '<input type="file" name="file[]" id="file_'+file_n+'"  accept="image/*" class="file" value="" onchange="upload_img(\'file_'+file_n+'\')" multiple="multiple" />'
 		$('#test').append(html);
