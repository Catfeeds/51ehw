    ...
    <div class="gongying_con">
    	<p class="gongying_weizhi"><a href="<?php echo site_url("home");?>">首页</a>&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp; &nbsp;<a href="<?php echo site_url('supply') ?>">更多供应信息</a></p>
        <!--清除浮动-->
        <div class="clearfix">
                ...
                <div class="gongying_conLeft_con02">
                	<ul>
                    	...
                    	<li <?php if($key%2 >0){ echo 'class="gongying_conLeft_li"';}?>>
                            ...
                            <span class="gongying_span110 liSpan_110" style="text-overflow: ellipsis;overflow: hidden;white-space: nowrap;"><?php if($detail["grade"]==1){echo "易货店会员";}else if($detail["grade"]==2){echo "旗舰店会员";}else if($detail["grade"]==3){echo "专卖店会员";}?></span>
