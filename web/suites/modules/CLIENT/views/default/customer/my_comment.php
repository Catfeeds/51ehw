                        ...
                        <div class="dingdanzhongxin_pingjia_con01_down" id="<?php echo 'comment_'.$k?>">
                            <ul>
                                ...
                                <?php if(!$v['comments_id']):?>    
                                    <li class = 'ok_on' style="border-right:0; width:158px"><a class="comment_btn" onclick="comment('<?php echo $k;?>','<?php echo $v['id']?>')">点击评价</a></li>
                                <?php else :?>
                                    <li class = 'ok_on' style="border-right:0; width:158px">已评价</li>
                                <?php endif;?>
                            </ul>
                        </div>
                     </div>
