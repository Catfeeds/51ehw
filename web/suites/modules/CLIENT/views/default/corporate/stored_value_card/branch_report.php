...
<div class="Box manage_new_Box clearfix">
       <div class="cmLeft manage_new_cmLeft">
            ...
            <div class="cmLeft_down">
            	<ul>
                    ...
                    <li><a href="#" >门店管理</a></li>
                    <li class="houtai_zijin_current"><a href="#" > 销售报表</a></li>
                </ul>
            </div>
        </div>
       <!--左边结束-->  
         ...
         <div class="stored_top">
          ...
          <div class="stored_sh_li">
             <div class="stored_sh_li_ad">
               <a href="#" class="stored_de">销售报表</a><a href="#">分店管理</a>
             </div>        
          </div>
            ...
            <div class="stored_sh_li_bao">
               <ul class="stored_sh_li_bao_ul">
                 <li>门店筛选：
                 <select name="theme" id="theme" class="stored_sh_li_bao_inp">
                ...
                <li>
                <span>消费时间：</span>
                <input type="text" value="" class="stored_input1" name="grant_start_at" onclick="WdatePicker()" readonly>
                <samp class="stored_input_samp1">至</samp>
                <input type="text" value="" class="stored_input1" name="grant_end_at" onclick="WdatePicker()" readonly>
                </li>
               <li style=" margin-right:0"><a class="stored_sh_cha" href="#">查询</a><a class="stored_sh_dao" href="#">导出EXCL</a></li>
               </ul>
            <p class="stored_sh_li_bao_ul_p">筛选结果消费总额：400货豆</p>
            </div>
            ...
            <div class="stored_zhong">
				...
				<tbody>
                    <tr class="tr1">
						...
						<th width="140px">消费门店</th>
						
					</tr>
                     <tr>
						<th width="160px">2016-11-08  12:00:00</th>
						<th width="120px">100</th>
						<th width="305px">iampm1</th>
						<th width="120px">二哈</th>
						<th width="140px">丽枫海珠店</th>
					</tr>
      ...
      <div class="result_null" style="margin-top:10px;" hidden>暂无内容，请点击上面添加按钮来添加产品</div>    
          </div>  
         </div>
       <!--右边结束-->    
         </div>
