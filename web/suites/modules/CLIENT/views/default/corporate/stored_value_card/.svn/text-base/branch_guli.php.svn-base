       ...
       <div class="cmLeft manage_new_cmLeft">
            ...
            <div class="cmLeft_down">
            	<ul>
                    ...
                    <li><a href="#" >门店管理</a></li>
                    <li><a href="#" > 销售报表</a></li>
                    <li class="houtai_zijin_current"><a href="#" >分店管理</a></li>
                </ul>
            </div>
        </div>
       <!--左边结束-->  
         ...
         <div class="stored_top">
            ...
            <div class="stored_chongg">
               <ul class="stored_chong_ki">             
                 <li class=""><span>分店名：</span><input type="text" class="stored_chong_ki_input" name="search_name" value="" placeholder="请输入储存卡名称"></li>
                 <li class=""><span>分店地址：</span><input type="text" class="n" name="search_name" value="" placeholder="请输入授权额"></li>
                 <li class=""><span>添加负责人：</span><a href="#" class="fuzenr_dianh">添加负责人</a></li>
                 <li class=""><span>负责人电话：</span><input type="text" class="n" name="search_name" value="" placeholder="请输入电话"></li>
               </ul>
          
               
               <div class="stored_chong_bottom" style="margin-top:100px;">
                 <a href="#" class="stored_chong_left">保存并生成二维码</a>
                 <a href="#" class="stored_chong_rigth">返回</a>
               </div>
