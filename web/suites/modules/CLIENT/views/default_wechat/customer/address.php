...
<?php if( isset($address) && count($address)>0){?>
	...
	<div style="border-bottom: 1px solid #F3F3F3; line-height: 35px;">
		<a href="<?php echo site_url('member/address/add');?>" style="font-size: 13px; padding-left: 10px; padding-right: 80%;">
    		<span>添加收货地址</span>	
...
<?php }else{ ?>
	...
	<div class="address_kong" style="text-align: center;">
		...
		<div
			style="text-align: center; line-height: 40px; background: #FED609; position: absolute; bottom: 5px; width: 94%; left: 50%; margin-left: -47%;">
