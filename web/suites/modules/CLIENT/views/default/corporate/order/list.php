...
.cmRight_con .dingdanguanli_01_top02 ul li{ margin-right:14px;}
</style>
            ...
            <div class="cmLeft_down">
            	<ul>
                    ...
                    -->
                     ...
                     <li <?php if( $order_state == 'card') echo'class="houtai_zijin_current"';?>>
                         <a href="<?php echo site_url('corporate/order/get_list/card');?>">线上储值卡订单(<?php echo $status_15;?>)</a>
                    </li>
                </ul>
            ...
            <div class="cmRight_con manage_new_cmRight_con manage_a_cmRight_con manage_b_cmRight_con manage_fenlei_cmRight_con manage_c_cmRight_con"  style="height:auto;">
            	<div class="dingdanguanli_01_top02">
                    <ul>
                        ...
                        -->
                         <li <?php if( $order_state == 'card') echo'class="dingdanguanli_01_top02_current"';?>>
                         <a href="<?php echo site_url('corporate/order/get_list/card');?>">线上储值卡订单(<?php echo $status_15;?>)</a>
                    	</li>	
                         <li style="margin-right:0">
                          <select name="branch_id" id="branch_id" class="stored_jil" onchange="change();">
                           <option selected="" value="0">分店筛选</option>
                          <?php foreach ($branch_info as $key =>$val){
                              if(isset( $search['branch_id'] ) && $search['branch_id'] != '' && $search['branch_id'] == $val['id']){?>
                                   <option  selected="" value="<?php echo $val['id'];?>" del><?php echo $val['branch_name'];?></option>
                          <?php    }else{?>
                              <option value="<?php echo $val['id'];?>" del><?php echo $val['branch_name'];?></option>
                          <?php } }?>
                          </select>
                  		 </li>
                    </ul>
                ...
                <div class="select1">
                    ...
                    <table width="910" height="34" border="0" cellpadding="0" cellspacing="0" class="table1_1 dingdan_border">
                    	<tr class="tr1" >
                            <th width="254px" style="text-align:left"><input type="checkbox" style="margin-right:68px; margin-left:15px">订单编号</th>
                            <th width="70px">商品数量</th>
                            <th width="150px">订单总款</th>
                    ...
                    <table width="910" height="120" border="0" cellpadding="0" cellspacing="0" class="table1_2">	
                    	<tr class="tr1">
                            <th width="254px" style="text-align:center">
                            	<p style="width:156px"><?php echo $order['order_sn'];?></p>
                            </th>
                            <th width="70px"><?php echo $order['num'];?></th>
                            <th width="150px">货豆：<?php echo  $order['total_price'];?></th>
                            <?php if($order['corporation_branch_id']){?>
                                 <th width="150px">消费门店:<?php echo $order['branch_name'];?><br></th>
                            <?php }else{?>
                            ...
                            <th width="88px" style="text-align:center" id="th_<?php echo $order['id']?>">
                            	...
                            	<!--<a href="#" style="color:#fe4101; text-decoration:underline">修改发货</a><br>-->
                                <?php if ($order ['status'] == 4 && $order['g_status'] != '' ):?>
                                    ...
                                    <?php elseif( $order['g_status'] == 1 ):?>
                                        <a href="javascript:;" onclick= "dispatch(<?php echo $order['id']?>)" class="dingdanguanli_01_fahuoBtn2" style="background:#fe4101">发货</a><br/>
                                    <?php endif;?>
                                ...
                                <?php if ($order ['status'] == 1 ) {?>
                            	   <a href="javascript:;" onclick= "receive(<?php echo $order['id']?>)"class="dingdanguanli_01_fahuoBtn2" style="background:#fe4101">确认接单</a><br/>
                            	   <a href="javascript:;" onclick= "cancel(<?php echo $order['id']?>)"class="dingdanguanli_01_fahuoBtn2" style="background:#fe4101">取消订单</a><br/>
                            	  <?php }?>
                            	  <?php if ($order ['status'] == 7 ) {?>
                            	   <a href="javascript:;" onclick= "Load_Pay(<?php echo $order['id']?>)"class="dingdanguanli_01_fahuoBtn2" style="background:#fe4101">支付手续费</a><br/>
                            	   
                            	  <?php }?>
                                <a href="<?php echo site_url('corporate/order/order_details/'.$order['id']);?>" style="color:#fe4101; text-decoration:underline">详情</a>
               ...
               <ul>
                 ...
                 <h3 style="font-weight:normal" id="not_cash_message" hidden>
                     <li style="margin:30px 0;">
                          <span style="color:#fe4101;">余额不足，请先进行充值！</span>
                     </li>
                 </h3>
				 <!-- 余额不足时候 end-->
               </ul>
