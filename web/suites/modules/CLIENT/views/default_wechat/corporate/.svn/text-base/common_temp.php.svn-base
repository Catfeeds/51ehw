...
<div class="shop-information">
	...
	<div class="shop-prestige">
		...
		<ul>
		    ...
		    <img alt="" src="<?php echo base_url($corp_amount['img_url']);?>" id="vendor-grade">
		    <?php } ?>
		    </li>
		    <li class="shop-information-left">交易勋章: 
		    <!-- <span class="icon-xunzhang01 shop-xunzhang"></span> -->
		    <?php for($i=0;$i<$month_amount['img_amount'];$i++){ ?>
		    <img alt="" src="<?php echo base_url($month_amount['img_url']);?>" id="vendor-grade">
		    <?php } ?></li>
		    <li class="shop-information-left"><p>会员背书:</p> 
		    <p class="shop-information-ml10">
	...
	<div class="shop-information-footer">
		<ul>
		    ...
		    <li><a href="tel:<?php echo $corporation['contact_mobile'];?>" class="shop-dial">拨打电话</a></li>
		</ul>
	</div>
	<!-- 即时通讯 拨打电话 结束 -->
</div>
