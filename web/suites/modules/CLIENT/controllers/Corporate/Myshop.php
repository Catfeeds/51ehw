...
//         $data['detail'] = $this->corporation_mdl->load($user_id);
        ...
        try {
            ...
            if (! empty($_FILES)) {
                ...
                if ($this->upload->do_upload('file')) {
                    ...
                    $cd['img_url'] = base_url()."uploads/C/uploads/" . $save_path . $uploaded['file_name'];
    ...
    public function make_QR_code($corporation_id)
    {
        ...
        $size = '400x400';
        $logo = FCPATH .UPLOAD_PATH.$corporation['img_url'];
        ...
        QRcode::png($data, FCPATH .UPLOAD_PATH . $file, $errorCorrectionLevel, $matrixPointSize, 1);

        $QR = imagecreatefromstring(file_get_contents(FCPATH .UPLOAD_PATH . $file));
