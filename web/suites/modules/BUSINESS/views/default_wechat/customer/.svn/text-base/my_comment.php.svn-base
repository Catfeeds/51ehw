 ...
 */
 function comment(id_product){
	 ...
	 html += '<ul>';
	 html += '<li class=""><a href="javascript:;">1</a></li>';
	 html += '<li class=""><a href="javascript:;">2</a></li>';
	 html += '<li class=""><a href="javascript:;">3</a></li>';
	 html += '<li class=""><a href="javascript:;">4</a></li>';
	 html += '<li class=""><a href="javascript:;">5</a></li>';
	 html += '</ul>';
	 html += '</div>';
	 html += '<div class="incomment">';
	 html += '<p class="fn-14">输入评论</p><span id="input_comment"></span>';
	 html += '<textarea  name="comment" class="incomment_tax" style="outline:none;width:100%; height:80px; border:1px solid #ccc; margin-top:5px;"></textarea>';
	 html += '<a href="javascript:void(0);" onclick=sub("'+id_product+'"); class="pay-style pay-weixin custom_button">提交</a>';
	 html += '</div>';
	 html += '</section>';
