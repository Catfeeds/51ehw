...
?>
        ...
        <form action="<?php echo site_url('customer/forget_password2') ?>?action=save" method="get" id="form">
            ...
            <ul>
                ...
                <li>短信验证码：<input type="text" placeholder="输入验证码" id="mobile_vertify" name="mobile_vertify">
                    ...
                    <div id="mverror" style="display:none;width:300px;float:right;margin-right:130px;margin-top:15px;color:red;font-size:15px;"></div>
                </li>
    ...
    function windowclose(){
        $.ajax({
            url:"<?php echo site_url('customer/unset_forget_session') ?>",
            type:"get",
            success:function(){
