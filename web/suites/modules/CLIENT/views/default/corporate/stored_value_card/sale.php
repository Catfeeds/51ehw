...
<div class="Box manage_new_Box clearfix">
       ...
       <!--右边-->  
         <div class="stored_top">
            <div class="stored_top_sh">门店管理</div>
          <div class="stored_sh">
          <div class="stored_sh_li">
             <div class="stored_sh_li_ad">
               <a href="#" class="stored_de">门店管理</a><a href="#">销售报表</a>
             </div> 
            <a class="stored_sh_rigth" href="#">添加门店</a>
            ...
            <div class="stored_zhong">
				...
				<tbody>
                    <tr class="tr1">
						...
						<th width="184px">门店地址</th>
						<th width="80px">门店负责人</th>
						<th width="100px">负责人电话</th>
						<th width="140px">门店创建时间</th>
						<th width="120px">门店今年营业额</th>
						<th width="80px">操作</th>
					</tr>
                     <tr>
						<th width="140px">丽枫酒店海珠店</th>
						<th width="184px">广东省广州······楼3211室</th>
						<th width="80px">二哈</th>
						<th width="100px">138 0013 8000</th>
						<th width="140px">2017-01-01</th>
						<th width="120px">2017-01-01</th>
						<th width="80px"><a href="#" style="color:#fe4a00;">查看详情</a></th>
					</tr>
