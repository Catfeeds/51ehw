	...
	function createBox( $fileInput, file, webUploader ) {
		...
		if ( $parentFileBox.find('.diyButton').length <= 0 ) {
			...
			var div = '<div class="diyButton"> \
						...
						<a class="diyCancelAll" href="javascript:void(0)" style="background-color:#72C312;">取消操作</a> \
					</div>';
...
$(function(){
  $(".renzheng_tab ul li").eq(0).click(function(){
	  ...
	  $(this).children().css("color","#fea33b");
	  })
    ...
    <div class="Box manage_new_Box renzheng_Box clearfix ">
        <div class="cmLeft manage_new_cmLeft">
            ...
            <div class="cmLeft_down">
            	<ul>
                	<li class="houtai_zijin_current"><a href="<?php echo site_url('corporate/myshop/get_shop') ?>">基本信息</a></li>
...
<!--                         <li>二维码 :</li> -->
                ...
                <div class="dianpu_01_right dropdown basicInformation_right">
                	<ul>
                        ...
                        <li><input type="text" name="address" oninput="region()" class="regsiter_02_input" value="<?php echo isset($detail['address'])?$detail['address']:"" ?>" placeholder="请输入具体地址"><a target="_blank" id="baidu_api" ><span class="icon-coordinate" style="color: #fea33b"> </span></a></li>
                        <li>
            ...
            <div class="dianpu_01_con02">
              ...
              <div class="renzheng_tab1">
                 ...
                 <div class="renzhengTab_con02" >
                     ...
                     <p style="float:left">失败原因：<span class="renzhengTab1_span"style="color:#fea33b"><?php echo isset($detail['approval_desc'])?$detail['approval_desc']:"" ?></span></p>
                 </div>
