                    ...
                    <div class="ui-login-left fn-left">
                        ...
                        <div class="ui-form-item fn-clear">
                                <span class="ui-loginframe-label fn-left">
                                    ...
                                    <label class="years">我已满18周岁并接受买酒服务条款</label>

                                </span>
                        </div>
                        <div class="ui-main-login-but">

                            <input name="ibtRegister" id="ibtRegister" type="image" name="ibtRegister" id="ibtRegister" class="btn-register" onclick="return validate('2');WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ibtRegister&quot;, &quot;&quot;, true, &quot;2&quot;, &quot;&quot;, false, false))" src="<?php echo THEMEURL; ?>images/bottom_login.gif"/>

							
                        </div>
                    </div>
                    <div class="ui-login-note">
                        <span>已经是红酒网的会员了？</span><a href="<?php echo  site_url('login/index')?>" title="立即登录" class="ui-registration-login"></a>
                    </div>
                </div>
            </div>
        </div>
