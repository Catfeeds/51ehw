    ...
    function my(){
        ...
        if($customer["idcard"]){
            ...
            if($shop){
                ...
                //查询卖家最后一张订单
                $LastOrder = $this->easyshop_order_mdl->LastOrder($shop["id"],1);
                if($LastOrder){
                ...
                //销售订单总数
                $OrderTotal = $this->easyshop_order_mdl->SalesOrder($shop["id"]);
                
            }
        }
        
        //查询买家最后一张订单
        $BuyersLastOrder = $this->easyshop_order_mdl->BuyersLastOrder($customer_id,1);
        if($BuyersLastOrder){
        ...
        //买家订单总数
        $BuyersTotal = $this->easyshop_order_mdl->BuyersOrder($customer_id);
