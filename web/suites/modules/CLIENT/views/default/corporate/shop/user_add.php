    ...
    <div class="Box manage_new_Box clearfix">
        ...
        <div class="names_set">
            ...
            <div class="data_set">
                ...
                <ul class="data_names data_inter" style="border:none; display:none;border-bottom:1px solid #ccc;">
                ...
                <?php }; ?>
                <?php }else{;?>
                <ul class="data_names data_inter" style="border-top: 1px solid #ccc; margin-top:20px;">
