...
<div class="header">
            <a href="javascript:history.back(0);" target="_self" class="icon-right" style="-webkit-transform: rotate(180deg);margin-top:8px;font-size: 20px;"></a>
            <a href="<?php echo site_url("corporate/card_package/send_record");?>" class="detailed" id="widget_submit" style="color: #fff; position: fixed; right:0;">发放记录</a>
            <p class="title">货包</p>
</div>
    ...
    <li class="commodity_detail-list">
        <a href="<?php echo site_url("corporate/card_package/details/".$v['id']);?>">
            ...
            <div class="commodity_record_list">
              ...
              <?php if($v["number"]){?>
              <a href="<?php echo site_url("corporate/card_package/send_view/".$v["id"]);?>" class="commodity_record_send custom_button">发放货包</a>
              <?php };?>
            </div>
        </a>
    </li>
