        ...
        <div class="cmRight manage_new_cmRight  manage_a_cmRight manage_b_cmRight" style="text-align: left">
          ...
          <div class="dianpu_01_con01 clearfix" id="recite_add">
              ...
              <div class="dianpu_ls">
                ...
                <div class="dianpu_01_right">
                	<ul>
                        <li id="img" ><img id='picture_img' src="<?php foreach ($image as $v){if($v['type']=='picture'){echo $picture = IMAGE_URL.$v['image_name'];}}?>" width="250" height="154" alt=""/></li>
...
<!--                  <div class="dianpu_zhong_r"><textarea placeholder="(必填，不少于100字，不多于500字)" name="personal" class="procureme"></textarea><span id="personal" class="recite_tip"></span></div> -->
                ...
                <input type="text" value="<?php echo $number;?>" id="number" hidden>
                    ...
                    <div style="margin-left:144px;">
                        ...
                        <div style="float:left;" class="parentFileBox" id="<?php echo $val['type'].'_'.$val['id']?>">
                            ...
                            <div class="viewThumb"> <img src="<?php echo IMAGE_URL.$val['image_name'];?>"> </div>  
                ...
                <div class="dianpu_01_right">
                	<ul style="margin-right:-47px;">
                        <li class="tj_t1 hover_it"id="img" style="position: relative"><img id='solicitude_1' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==1){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                            <!--编辑区 开始-->
                           <div class="editCon">
                        ...
                        <li class="tj_t1 hover_it"id="img" style="position: relative"><img id='solicitude_2' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==2){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                           <!--编辑区 开始-->
                           <div class="editCon">
                        ...
                        <li class="tj_t1 hover_it"id="img" style="position: relative" ><img id='solicitude_3' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==3){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                           <!--编辑区 开始-->
                           <div class="editCon">
                        ...
                        <li class="tj_t1 hover_it"id="img" style="position: relative"><img id='solicitude_4' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==4){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                             <!--编辑区 开始-->
                           <div class="editCon">
                        ...
                        <li class="tj_t1 hover_it"id="img" style="position: relative" ><img id='solicitude_5' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==5){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                            <!--编辑区 开始-->
                           <div class="editCon">
                        ...
                        <li class="tj_t1 hover_it"id="img" style="position: relative" ><img id='solicitude_6' src="<?php foreach ($image as $v){if($v['type']=='solicitude' && $v['number']==6){echo IMAGE_URL.$v['image_name'];}}?>" width="200" height="165" alt=""/><p></p>
                           <!--编辑区 开始-->
                           <div class="editCon">
