			        ...
			        <table class="table_border">
                        <tbody>
                            ...
                            <tr class="tr1">
                                ...
                                <th width="140px" style="text-align: left; padding-left: 10px"><?php echo $v['min_vip_price']."~".$v['max_vip_price'];?></th>				
                                ...
                                <?php if($v['ispublish'] != 1 && $v['ispublish'] != 2 ){;?>
                                ...
                                <?php };?>  
                                    <a href="javascript:operation(<?php echo $v['id']?>,<?php echo $v['ispublish'];?>);"  style="font-size: 13px;text-decoration: underline;padding-right: 5px;">
                                        <?php 
                                        switch($v['ispublish']){
                                           case 1:
                                               echo "取消审核";
                                ...
                                <th width="77px" ><a href="javascript:void(0);" class="tanchuang01"><span style="width:53px;display:block;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;"><?php echo $v['remark'];?></span></a></th>
                            </tr>
                        </tbody>
					</table>
					<?php };?>
...
<div class="dingdan4_3_tanchuang" id="dingdan4_3_tanchuang01" style="display:none">
  <div class="dingdan4_3_tanchuang_con">
      ...
      <div class="dingdan4_3_tanchuang_btn">
          <div class="dingdan4_3_btn01" style="background:#ccc;margin-left: 275px;"><a onclick=hiding()>返回</a></div>
...
<script type="text/javascript">
    ...
    function operation(id,state){
	   ...
	   $("#sure").attr('href',"<?php echo site_url("member/demand/change/".$status);?>"+'/'+id+'/'+state+'?keyword='+"<?php echo $keyword;?>");
