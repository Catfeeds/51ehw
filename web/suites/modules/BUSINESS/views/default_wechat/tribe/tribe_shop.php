...
<style type="text/css">
  ...
  .essay_classify_fuwu_list {border-bottom: 0px solid #ddd;padding: 0 2px 2px 2px;float: left;width: 50%;}
  .essay_classify_fuwu_list a {overflow: hidden;display: block;width: 100%;}
  .essay_classify_fuwu_list_text {float: left;padding:0 5px;}
  .essay_classify_fuwu_list_img {width: 100%;float: left;overflow: hidden;}
  .essay_classify_fuwu_list_img img {display: block;height: 100%;width:100%;}
  .essay_classify_fuwu_list_text .essay-goods-monery {margin: 0px 5px 5px 5px;}
...
<style type="text/css">
  ...
  .tribe_sousuo {width: auto!important;color: #fff;position: absolute;right: 3%;top: 12px;font-size: 15px!important;padding-left: 0!important;}
  ...
  .essay_preview_nav ul li input {display: block;width: 100%;border:none;height: 45px;background: #fff;font-size: 15px;}
  .tribal_nav_input {color: #fed602;border-bottom: 1px solid #fed602!important;}
  .tribal_head_back {position: fixed;color: #fff;font-size: 20px;top: 17px;left: 10px;z-index: 999;}
</style>

<!-- 部落搜索 -->
<div class="search-header">
   <a href="javascript:history.back()" class="icon-back tribal_head_back"></a>
   <!-- 搜索框 -->
   <form action="<?php echo site_url('Search/wechat_search_goods') ?>" method="get" id="form_search" >
       <div class="nav_search">
          <p style="background-color: #fff;width:70%;border:1px solid #000;border-radius:3px;margin:-2px auto;padding-left:10px;margin-left: 13%;">
...
<div style="height:50px;"></div>
  ...
  <div class="essay_preview_nav tribe_shop_nav">
    <ul>
        <li class="essay_classify"><input type="button" onclick="navigation(this,1);" id="essay_active_d" class="tribal_nav_input" value="企业发布" >
        <li class="essay_sales"><input type="button" onclick="navigation(this,2);" id="essay_active_e" class="" value="快速交易" >
        <li class="essay_sales"><input type="button" onclick="navigation(this,3);" id="essay_active_f" class="" value="企业展示" >
    </ul>
  </div>
...
$(function () { 
  ...
  var width_01 = $("#style .essay_classify_fuwu_list_img").width();
  $(".essay_classify_fuwu_list_img").height(width_01);
...
//      console.log('url='+url);
  ...
  function navigation(obj,type){
    ...
    navigate = type;
    //特效
    $(".essay_preview_nav ul li").siblings().children('input').removeClass('tribal_nav_input');
    $(obj).parent().children('input').addClass('tribal_nav_input');
      types = type;
      if(type == "3"){
          url = "<?php echo site_url("corporation_style/Topic_List");?>";
      ...
      $("#tribal_new_nav_active1").removeClass('tribal_new_nav_active');
        $(".essay_preview_nav ul li").siblings().children('input').removeClass('tribal_nav_input');
        $(".essay_preview_nav ul li").eq(2).children('input').addClass('tribal_nav_input');
          $("#corporationstyle").show();
      $("#Mall").hide();
      }else if(type == '2') {
        document.getElementById("form_search").action = "<?php echo site_url('easyshop/product/tribe_search_goods') ?>";
        url = "<?php echo site_url("tribe/loading_goods");?>";
        $(".head_top").hide();
