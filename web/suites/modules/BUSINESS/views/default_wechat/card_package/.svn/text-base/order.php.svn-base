...
.queding-bt {width: 50%;height: 40px;background: #ffd600;text-align: center;margin: auto;margin-bottom: 15px;margin-top: 5px;}
.queding-bt a {display: inline-block;line-height: 44px;width: 100%;font-size: 17px;}
...
<form id="order_save" method="post" name="order_save">
	<div class="page clearfix">
		...
		<div class="" style="position: relative; margin-left: 40px; margin-top: 10px; font-size: 14px; color: #363636;">
			<a href="">
    			<em class="icon-locationfill" style="position: absolute; top: 18px; left: -29px; color: #FED609; font-size: 20px;"></em>
    			<span>
    			...
    			<span style="display: block; padding-top: 5px;">联系电话：
    				<span>1851008611</span>
    			</span>
    			<span style="padding-top: 5px;">收货地址：
    				<span>广州市海珠区富力天域中心</span>
    			</span>
			</a>
		</div>
		<!--收货地址 结束-->
		
		<div style="display:none;"><input type="text" id="address_id" value="ghg"></div>
		...
		<div class="order_confirm firm_order_list">
            ...
            <ul style="border-bottom: 1px solid #e6e6e6; font-size: 14px;">
				<li><em class="icon-shop"></em> <span
					style="margin-left: 10px; line-height: 30px;">广州市海珠区富力天域中心</span>
				</li>
			</ul>
			<ul class="order_list" style="margin-top: 5px;">
				<li>
				<input type="checkbox" checked="" class="selected_info selected_info_2" id="879_232" name="item[]" value="618ed573c15e28cc4342bff363f00507" style="display: none">
					<img src="http://image.51ehw.com/uploads/photos/2016/03/29/957_20160329144757.jpg" alt="【围巾/丝巾/披肩】洁丽雅礼盒 绝世倾城丝巾（2）100%桑蚕丝" class="fn-left good_list_img" onerror="this.src='images/default_img_b.jpg'">
					<div class="order_info">
						<h2 class="goods_list_text" style="margin-left: 0px;">【围巾/丝巾/披肩】洁丽雅礼盒 绝世倾城丝巾（2）100%桑蚕丝</h2>
						<p class="mm01_font1">
                                                                             <span>花色</span>
                                                                        </p>
						<p class="c9">
           ...
           <ul style="border-top: 5px solid #f4f4f4;border-bottom: 1px solid #f4f4f4;">
                   ...
                   <a href="javascript:void(0);">商品金额<span style="float:right;">1600劵</span></a>
            </li>
...
<div class="juan-header">
	<span class="icon-back juan-icon">返回</span><span>使用优惠劵</span>
</div>
...
<div class="commodity_record" id="shopping-cart-list">
	<ul style="display: block;overflow: hidden;">
	    <li class="commodity_detail-list">
	       <a href="javascript:void(0);">
	       	<div>
		      <img src="images/commodity_send01.png" alt="">
	       </div>
	       </a>
	       <label><input type="checkbox" value="1" class="icon-roundcheckfill icon-quan choose-icon"></label>
	    </li>
	    <li class="commodity_detail-list">
	    	<a href="javascript:void(0);">
	       	<div>
	...
	<ul style="display: none;">
	    <li class="commodity_detail-list">
	       <a href="javascript:void(0);">
	       	<div>
		      <img src="images/commodity_send03.png" alt="">
	       </div>
	       </a>
	    </li>
	    <li class="commodity_detail-list">
...
<script type="text/javascript">
	...
	$("#shopping-cart-list ul li label input").click(function(){
            if(this.checked){    
