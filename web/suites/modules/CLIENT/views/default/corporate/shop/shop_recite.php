...
<!--                     	<a class="dianpu_recite_btn">预览</a> -->
         ...
         <th width="130px"><?php echo substr($v['updated_at'],0,11);?></th>
                      ...
                      <th width="200px">
                         <a href="<?php //echo site_url('corporate/resource/detail').'/'.$v['id'];?>" style="color:#fe4101; text-decoration:underline">详情</a> 
                      </th> -->
                      
                      <th width="200px">
                      <a href="
                      <?php echo site_url('corporate/resource/edit').'?id='.$v['id']; ?>"style="color: #fe4101; text-decoration: underline;margin:0 15px;">编辑</a>
					  <a href="javascript:delects(<?php echo $v['id']?>);" style="color: #aeaeae; text-decoration: underline;margin:0 15px;">删除</a>
				      <a href="<?php echo site_url('corporate/resource/preview').'/'.$v['id'];?>"target="_blank"style="color: #fe4101; text-decoration: underline;margin:0 15px;">预览</a></th>
                  </tr>
              </table>
              <?php endforeach;?>
              <div class="showpage">
