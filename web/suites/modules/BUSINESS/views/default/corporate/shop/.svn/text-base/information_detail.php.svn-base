          ...
          <div class="introduction_top1"><p>公司简介</p></div>
           <div class="introduction_con">
            <div class="introduction_connei">
              ...
              <div class="introduction_connei_r2"><img src="<?php foreach ($image as $v){if($v['type']=='picture'){echo IMAGE_URL.$v['image_name'];}}?>"/></div>
            </div>
           </div>
       </div>
    </div>
          ...
          <div class="introduction_top1"><p>企业实力展示</p></div>
           <div class="gong_enterprise">
             <ul>
               ...
               <?php if($v['type']=='ce'){?>
               <li><img src="<?php echo IMAGE_URL.$v['image_name'];?>"/></li>
               <?php };?>
       ...
       <div class="introduction">
          ...
          <div class="gong_enterprise2">
             <ul>
               ...
               <li><img src="<?php echo IMAGE_URL.$v['image_name'];?>"/><span><?php echo htmlentities($v['title']);?></span></li>
               <?php };?>
