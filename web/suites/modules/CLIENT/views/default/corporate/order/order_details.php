...
<title>51易货网</title>
<style>
.dingdanxiangqing_width_right_zuo{ width:110px; text-align:left; display:inline-block}
.dingdanxiangqing_width_right_zuo1{display: inline-block}
.dingdanxiangqing_width_right li{ float:left; width:100%;}
.eh_footer_box{ overflow:hidden}
</style>
</head>
    ...
    <div class="Box manage_new_Box clearfix">
        ...
        <div class="cmRight manage_new_cmRight  manage_a_cmRight manage_b_cmRight">
           ...
           <!-- <div class="dingdan_kehuguanli_top">
            ...
            <div class="dingdanxiangqing_con clearfix">
                ...
                <div class="dingdanxiangqing_width_right">
                	<ul>
                	    ...
                	    <li><span class="dingdanxiangqing_width_right_zuo">支付方式:</span><span class="dingdanxiangqing_width_right_zuo1">
                	    <?php 
                            if( $details['order_type'] == 1 )
                            {
                                echo '货豆支付';
                            }else if( $details['order_type'] == 2  )
                            {
                                echo '线上储值卡支付';
                                
                            }else if( $details['order_type'] == 3 )
                            { 
                                echo '货豆+储值卡支付';
                            }
                        ?> 
                	    </span></li>
                    	 <?php if( $details['order_type']== 2 || $details['order_type'] == 3){ ?>
                    	 	<li><span class="dingdanxiangqing_width_right_zuo">储值卡名称:</span><span class="dingdanxiangqing_width_right_zuo1"><?php echo $details['savings_card_name']?></span></li>
                        	<li><span class="dingdanxiangqing_width_right_zuo">储值卡支付金额:</span><span class="dingdanxiangqing_width_right_zuo1"><?php echo $details['card_amount']?></span></li>
                        <?php }?>
                        <?php if( $details['order_type'] == 3 ){?>
                			<p> <span><i class="yuhebu">货豆支付金额：</i><?php echo number_format($details['total_price'] - $details['card_amount'],2,'.','') ?> M</span></p>
                		<?php }?>
                        ...
                        <li><span class="dingdanxiangqing_width_right_zuo">付款时间:</span><span class="dingdanxiangqing_width_right_zuo1"><?php echo empty($details['pay_time']) ? "暂无":$details['pay_time'];?></span></li>
            ...
            <?php if(!$details['corporation_branch_id'] ){?>
            <h4>收货和物流信息</h4>
            <div class="dingdanxiangqing_con clearfix">
            	<!--<div class="dingdanxiangqing_width_left">-->
                	<!--<ul>
                        	...
                        	<ul>
                                <li class="dingdanxiangqing_con3_margin">
                                    <span class="gouwuche_mm01">
                                       <img src=<?php echo isset($v['goods_thumb'])&&$v['goods_thumb']!=null? IMAGE_URL.$v['goods_thumb']:"images/shouhuo_shili.jpg" ?> width="67" onerror="this.src='images/hotSale_pic1.png'"  alt=""/ style="margin-top:10px;">
