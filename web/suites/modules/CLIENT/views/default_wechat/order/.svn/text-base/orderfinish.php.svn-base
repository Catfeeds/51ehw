...
<!-- 		<span class="order_span_text">请及时完善订单以便发货</span> -->
	...
	<div style="margin-top: 45px;">
			...
			<a href="<?php echo !empty($order_id) ? site_url('member/order/detail/'.$order_id) : site_url('member/order')?>" style="display: block;text-align: center; width: 90%; background: #fe4101; color: #fff; font-size: 17px; line-height: 40px; margin: auto; margin-bottom: 10px; border-radius: 2px;">我的订单</a>
		    <a href="<?php echo site_url('Home')?>" style="display: block;text-align: center; width: 90%; background: #fe4101; color: #fff; font-size: 17px; line-height: 40px; margin: auto; margin-bottom: 10px; border-radius: 2px;">继续购物</a>
