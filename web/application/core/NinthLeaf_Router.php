...
class NinthLeaf_Router extends CI_Router
{
    ...
    protected function _validate_request($segments)
    {
        ...
        while ($c -- > 0) {
            ...
            if ((! file_exists(APPPATH . 'controllers/' . $test . '.php') && is_dir(APPPATH . 'controllers/' . $this->directory . $segments[$i])) || (! file_exists(SUITEPATH . $suite . '/controllers/' . $test . '.php') && is_dir(SUITEPATH . $suite . '/controllers/' . $this->directory . $segments[$i]))) {
    ...
    protected function _set_request($segments = array())
    {
        ...
        if (substr($segments[0], 0, 1) == "_") {
            ...
            for ($i = 1; $i < $c; $i ++) {
                ...
                if (file_exists(APPPATH . 'controllers/' . $test . '.php') || file_exists(SUITEPATH . $this->suite . '/controllers/' . $test . '.php')) {
                    // $this->set_directory($segments[$i], TRUE);
