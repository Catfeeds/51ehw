        ...
        <div class="clearfix">
            ...
            <div class="product">
                ...
                <lable class="item" id="product_price_item">
                    ...
                    <span class="red" id="product_price" style="color: #333333; font-size: 15px; font-weight: bold;"> <?php echo $details['vip_price'] == 0 ? "0":number_format($details['vip_price'], 2);?> 货豆</span></lable>
                <div class="line"></div>
