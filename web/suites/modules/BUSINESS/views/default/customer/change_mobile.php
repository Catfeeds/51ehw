        ...
        <form action="<?php echo site_url('member/save_set/update_mobile') ?>" method="post" id="form">
            <p class="pay_t"><a href="<?php echo site_url("home");?>">首页</a> > <a href="javascript:void(0);">个人中心</a> > <a href="javascript:void(0);">安全设置</a> >  <a href="javascript:void(0);" class="pay_current">更换手机</a></p>
    ...
    <script>
       ...
       function send_valitaty(){
            if($("#mobile").val() != "" && /^0{0,1}(13[0-9]|15[0-9]|18[0-9]|17[0-9]|14[0-9])[0-9]{8}$/.test($('#mobile').val())){
       ...
       $('#mobile').blur(function(){
   	       if($('#mobile').val()==''){
                ...
                $('#merror').show();
   	   	   }else if(!/^0{0,1}(13[0-9]|15[0-9]|18[0-9]|17[0-9]|14[0-9])[0-9]{8}$/.test($('#mobile').val())){
      	   		$('#merror').html('请填写正确的手机号码！');
                $('#merror').show();
   	   	   }
       });
